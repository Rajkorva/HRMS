...
const W2PartTime = () => {
  ...
  const [employees, setEmployees] = useState(employementType === 'W2 PArt Time' ? initialEmployees : []);
  const [selectedEmployee, setSelectedEmployee] = useState(null);
  const [isEditing, setIsEditing] = useState(false);
  const [editIndex, setEditIndex] = useState(null);

  useEffect(() => {
    if (initialState.employees && employementType === 'W2 Part Time') {
