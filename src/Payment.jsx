...
const Payment = () => {
  ...
  const handleSave = (e) => {
    e.preventDefault();
    navigate('/payment-preview', { state: formDataState });
  };
        ...
        <>
          ...
          <div className='payment-inputs'>
            ...
            <div>
              ...
              <DatePicker
                selected={formDataState.transactionDate}
                onChange={(date) => setFormDataState({ ...formDataState, transactionDate: date })}
              />
            </div>
            <div>
              ...
              <input
                ...
                value={formDataState.referenceNumber}
                onChange={handleChange}
              />
            </div>
            <div>
              <label htmlFor="accountCategory">Account Category:</label>
              <select id="accountCategory" name="accountCategory" onChange={handleChange}>
                <option value="">Select</option>
                <option value="ProductSalesRevenue">Product Sales Revenue</option>
          ...
          <table>
            <thead>
            <tr className='CheckBox' >Check Box<input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"/></tr>
              <tr>
                <th>Description</th>
                <th>Due Date</th>
            ...
            <tbody>
              <tr>
                <td>{formDataState.description}</td>
                <td><p id="dueDate">{formDataState.dueDate.toLocaleDateString()}</p></td>
                <td><p>{formDataState.total}</p></td>
                <td><p>{formDataState.balanceDue}</p></td>
                <td>
                  <input
                    type="text"
                    name="amount"
